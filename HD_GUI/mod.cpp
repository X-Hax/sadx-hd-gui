...
extern "C"
{
	...
	__declspec(dllexport) void __cdecl Init(const char *path, const HelperFunctions &helperFunctions)
	{
		...
		// Various fixes
		WriteData<1>((char*)0x913122, 0x48); // Offset sprite UV for the Adventure ring count to fix artifacts
		WriteData<1>((char*)0x91BB5A, 0x48); // Offset sprite UV for the Adventure ring count to fix artifacts (Big)
		WriteData((float*)0x0046FBF5, 52.0f); // Big Adv Field ring sprite position
